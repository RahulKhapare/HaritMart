...
public class P {
    ...
    public static String baseUrl = "https://dev.digiinterface.com/2020/grocery/webservices/";
    public static String imgBaseUrl ="https://dev.digiinterface.com/2020/grocery/";
    ...
    public static String subscribe_newsletter="subscribe_newsletter";
    ...
    public static String bill_phone2="bill_phone2";
